...
const caseSwiper = new Swiper(".promotion-cases .swiper", {
   slidesPerView: 1,
   navigation: {
      prevEl: ".promotion-cases .swiper-button-prev",
      nextEl: ".promotion-cases .swiper-button-next",
   },
});
accordion(".promotion-faq__header", ".promotion-faq__spoiler");
